            ...
            <div class="pt-10 pb-6 pl-11 pr-12 bg-black-2 h-100 d-flex flex-column dark-mode-texts">
                <div class="pb-9">
                    <h3 class="font-size-7 text-white line-height-reset pb-4 line-height-1p4">
                        <?=empty($companyName) || $companyName === 'Sample Company Pvt Ltd' ? 'DoomeyeHRM Login' : $companyName?>
                    </h3>
                    <p class="mb-0 font-size-4 text-white">Log in to continue to your DoomeyeHRM account</p>
                    ...
                    <?php } else {?>
                        <img src="<?=BASE_URL?>images/doomeyehrm-login.png" style="width:80%;margin-top: 20%;"/>
                    <?php }?>
                </div>
                <div class="border-top border-default-color-2 mt-auto">
                    <div class="d-flex mx-n9 pt-6 flex-xs-row flex-column">
                        <div class="pt-5 px-3">
                            <a href="https://www.linkedin.com/company/doomeyehrm" target="_blank">
                        ...
                        <div class="pt-5 px-3">
                            <a href="https://www.facebook.com/doomeyehrm" target="_blank">
                            <p class="bg-white circle-56 font-size-6 mr-7">
                        ...
                        <div class="pt-5 px-3">
                            <a href="https://twitter.com/doomeyehrm" target="_blank">
                                <p class="bg-white circle-56 font-size-6 mr-7">
                        ...
                        <div class="pt-5 px-3">
                            <a href="https://github.com/doomeyehrm" target="_blank">
                                <p class="bg-white circle-56 font-size-6 mr-7">
                        ...
                        <div class="pt-5 px-3">
                            <a href="https://doomeyehrm.com" target="_blank">
                                <p class="bg-white circle-56 font-size-6 mr-7">
                        ...
                        <div class="pt-5 px-3">
                            <a href="https://doomeyehrm.gitbook.io/doomeyehrm/" target="_blank">
                                <p class="bg-white circle-56 font-size-6 mr-7">
